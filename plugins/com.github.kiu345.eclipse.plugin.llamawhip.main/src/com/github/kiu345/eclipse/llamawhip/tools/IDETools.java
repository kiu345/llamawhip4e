package com.github.kiu345.eclipse.llamawhip.tools;
...
import com.github.kiu345.eclipse.llamawhip.ui.util.StringEditorInput;
import com.github.kiu345.eclipse.llamawhip.util.TextCompareInput;
...
public class IDETools {
    ...
    public EditorInfo getEditorContent(@P(required = true, value = "The editor name") String name) {
    ...
    @Tool(
        {
                ...
                "Returns { \"status\": \"OK\"} or { \"status\": \"ERROR\"} depending on operation. Do not repeate the tool call!"
        }
    )
    public String openNewEditorWindow(
        ...
        Display.getDefault().asyncExec(() -> {
            for (String editorId : editorPriorityList) {
                try {
                    ...
                    if (IDEUtils.isEditorAvailable(editorId)) {
