...
public class ApplyPatchFunction extends BrowserFunction {
    ...
    public ApplyPatchFunction(Browser browser, String name, Handler handler) {
        super(browser, name);
        if (handler == null) {
    ...
    public Object function(Object[] arguments) {
        if (arguments.length > 0 && arguments[0] instanceof String) {
            ...
            if (StringUtils.isNotBlank(codeBlock)) {
                handler.onApplyPatch(codeBlock);
            }
        }
        return null;
    }
