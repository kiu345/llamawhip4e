...
public class BrowserScripting {
    ...
    /**
     * Provides some default javascript fragments
     */
    public static class ScriptBuilder {
         ...
         */
        public ScriptBuilder scrollDown(boolean scrollDown) {
            this.scrollDown = scrollDown;
            return this;
        }

        /**
         * Add the key listener to the input file
         */
        public ScriptBuilder addKeyListener(boolean addKeyListener) {
            this.addKeyListener = addKeyListener;
            return this;
        }

        /**
         * Run the code highlight script
         * 
         * @param highlight
         * @return
         */
        public ScriptBuilder highlight(boolean highlight) {
            this.highlight = highlight;
            return this;
        }

        /**
         * Run selected functions in the browser widget
         * 
         * @return true if the operation was successful and false otherwise
         */
        public boolean run(Browser browser) {
            StringBuilder builder = new StringBuilder();
            browser.execute("");

            if (highlight) {
                builder.append("hljs.highlightAll();\n");
            }
            if (scrollDown) {
                builder.append("window.scrollTo(0, document.body.scrollHeight);\n");
            }
            if (addKeyListener) {
                builder.append("addKeyCapture();\n");
            }

            return browser.execute(builder.toString());
        }
    }
    ...
    /**
     * Create a new default script builder instance
     */
    ...
    public static String loadJavaScripts() {
        ...
        for (String file : jsFiles) {
            try (InputStream in = FileLocator
                    .toFileURL(URI.create("platform:/plugin/" + Activator.PLUGIN_ID + "/js/" + file).toURL())
                    .openStream()) {
